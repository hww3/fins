...
int add(array tables_to_add)
{
  ...
  // first, we figure out what the object should be called.
    ...
    {
      Stdio.write_file(fn, Tools.String.NamedSprintf()->named_sprintf(ddc, (["table": t])));
    ...
    {
      Stdio.write_file(fn, Tools.String.NamedSprintf()->named_sprintf(dic, (["model_id": model_id, "objname": objname])));
